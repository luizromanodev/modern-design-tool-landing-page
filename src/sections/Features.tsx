            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                        ...
                        <div className="aspect-video flex items-center justify-center">
                            <p className="text-4xl font-extrabold text-white/20 group-hover:text-white/10 transition duration-500 text-center">
                                ...
                                <span className="relative">
                                    <span className="relative z-10 bg-clip-text text-transparent bg-gradient-animated bg-size-400 group-hover:animate-gradient transition-[background-position] duration-500 ease-in-out">
                                        incredible
                                    </span>
                                    <video
                    ...
                    <FeatureCard
                        ...
                        description="Powerful commands to help you to create designs
                                more quickly"
